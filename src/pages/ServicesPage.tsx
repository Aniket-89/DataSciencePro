    ...
    <section className="my-16">
      <div className="w-full h-96 flex flex-col items-center justify-center mx-auto text-center mb-16 relative overflow-hidden">
        ...
        <p className="text-lg text-gray-50 max-w-2xl mx-auto">
          We help businesses move forward with research-driven insights and
          intelligent data solutions. Whether you're entering a new market,
          validating a strategy, or solving a specific challenge — our services
          are built to deliver clarity, action, and results.
        </p>
      </div>
