...
const caseStudies = [
	{
		...
		industry: 'Retail',
		challenge:
			'A leading online retailer struggled with declining conversion rates and cart abandonment.',
		solution:
			'Implemented advanced customer segmentation and behavioral analytics to identify key drop-off points and optimization opportunities.',
		results: [
