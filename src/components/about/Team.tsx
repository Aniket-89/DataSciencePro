...
const team: TeamMemberType[] = [
  {
    ...
    brief:
      "Expert in building data pipelines and ETL processes. Specialized in Apache Spark and Hadoop.",
  ...
  },
  {
    ...
    brief:
      "Focuses on natural language processing and transformer models. Previously at OpenAI.",
  ...
  },
  {
    ...
    brief:
      "Expert in business intelligence and statistical analysis. Former consultant at McKinsey.",
  ...
  },
  {
    ...
    brief:
      "Specializes in DevOps and cloud architecture. AWS certified solutions architect.",
    image: "/team/alex.jpg",
    socials: {
