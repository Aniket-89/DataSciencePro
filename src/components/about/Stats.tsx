...
const stats = [
  ...
  { value: 200, symbol: "+", label: "Industries Covered" },
  { value: 30, symbol: "%", label: "Repeat Clients" },
  { value: 500, symbol: "K+", label: "Panel Size" },
  {
    value: 100,
    symbol: "%",
          ...
          {stats.map((stat, index) => (
            <div key={index} className="text-center p-4 transition-colors">
              ...
              <CountUp
                ...
                direction="up"
                duration={1}
                className="count-up-text text-h3 mb-4 font-semibold text-[#DDA853] transform transition-transform"
              />
